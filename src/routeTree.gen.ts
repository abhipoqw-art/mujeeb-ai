...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/api/chat' | '/api/edit-image' | '/api/generate-image'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/api/chat' | '/api/edit-image' | '/api/generate-image'
  id: '__root__' | '/' | '/api/chat' | '/api/edit-image' | '/api/generate-image'
